...
chrome.runtime.sendMessage(
  ...
  (response) => {
    ...
    document.getElementById("autoinsertanswer-input").checked =
      response.autoinsertanswer;
    document.getElementById("autosubmit-input").checked = response.autosubmit;
    document.getElementById("autosubmitdelaymin-input").value =
      response.autosubmitdelaymin;
    document.getElementById("autosubmitdelaymax-input").value =
      response.autosubmitdelaymax;
    document.getElementById("autosubmitdelaymin-value").innerText =
      response.autosubmitdelaymin;
    document.getElementById("autosubmitdelaymax-value").innerText =
      response.autosubmitdelaymax;
    document.getElementById("typingdelay-input").value = response.typingdelay;
    document.getElementById("typingdelay-value").innerText =
...
document
  .getElementById("autoinsertanswer-input")
...
document
  .getElementById("autosubmit-input")
  .addEventListener("change", function () {
    chrome.runtime.sendMessage({
      message: "autosubmit",
      value: this.checked,
...
const autosubmitdelayminInput = document.getElementById(
  "autosubmitdelaymin-input"
);
const autosubmitdelaymaxInput = document.getElementById(
  "autosubmitdelaymax-input"
);
const autosubmitdelayminValue = document.getElementById(
  "autosubmitdelaymin-value"
);
const autosubmitdelaymaxValue = document.getElementById(
  "autosubmitdelaymax-value"
);
...
document
  .getElementById("typingdelay-input")
